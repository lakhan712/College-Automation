...
<html>
    ...
    <meta name="author" content="">
        ...
        <title>Special Admin :: Add Admin </title>
    ...
    <body>        
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item ">
              <a href="spl_admin_dash.jsp">  <button type="button" class="btn btn-info m-2 fa fa-home"> Home</button></a>
    ...
    <main role="main">
      ...
      <div class="jumbotron mt-5">
          <p class="fa fa-mortar-board"> <kbd><span class="text-primary">Special Admin </span> </kbd></p>
           <h2 class="shadow-none p-4 mb-4" align="center">Add Admin</h2>
        
      </div>
  
       <div align="center">  <h1>Add Admin</h1></div><br><br>
<div class="container">
...
<%! int a=1;%>
      ...
      <div align="center">  <h1>Admin Summary</h1></div><br><br>
...
function update(id,rid){
           ...
           $.ajax({
            type : "POST",
            url : "/StudentRegistration/upd_admin",
           // data : "name=" + name, "email=" + email, "mobile=" + mobile, "username=" + username, "password=" + password  
