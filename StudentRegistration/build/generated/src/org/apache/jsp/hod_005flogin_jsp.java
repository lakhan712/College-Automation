...
public final class hod_005flogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try{
      ...
      out.write("<!DOCTYPE html>\n");
      out.write("<html>\n");
      out.write("<head><title>HOD:Login</title>\n");
      ...
      out.write("               <h2 class=\"shadow-none p-4 mb-4 bg-light\">HOD Login</h2>\n");
      out.write("               \n");
    ...
    String sql = "select * from master_hod where username='"+username+"' and password='"+password+"'";
    try{
