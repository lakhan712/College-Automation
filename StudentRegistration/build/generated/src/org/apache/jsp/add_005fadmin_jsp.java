...
public final class add_005fadmin_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 int a=1;
  ...
  String id = session.getAttribute("ad_id").toString();
if(id.equals("")) {
    response.sendRedirect("spl_admin_login.jsp");
      ...
      out.write("        <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\">\n");
      out.write("        <title>Special Admin :: Add Admin </title>\n");
      out.write("       \n");
      out.write("    </head>\n");
      out.write("    \n");
      out.write("    <body>        \n");
      ...
      out.write("              <a href=\"spl_admin_dash.jsp\">  <button type=\"button\" class=\"btn btn-info m-2 fa fa-home\"> Home</button></a>\n");
      out.write("            \n");
      out.write("          </li>\n");
      ...
      out.write("          <p class=\"fa fa-mortar-board\"> <kbd><span class=\"text-primary\">Special Admin </span> </kbd></p>\n");
      out.write("           <h2 class=\"shadow-none p-4 mb-4\" align=\"center\">Add Admin</h2>\n");
      out.write("        \n");
      out.write("      </div>\n");
      out.write("  \n");
      out.write("       <div align=\"center\">  <h1>Add Admin</h1></div><br><br>\n");
  ...
  String id2="";
    ...
    String sql6 = "select * from registerar";
    try{
      ...
      out.write("\n");
      out.write("\n");
      out.write("      <div align=\"center\">  <h1>Admin Summary</h1></div><br><br>\n");
      out.write("      \n");
      out.write("<div class=\"container\">\n");
 ...
 a=1;
      ...
      out.write("           $.ajax({\n");
      out.write("            type : \"POST\",\n");
      out.write("            url : \"/StudentRegistration/upd_admin\",\n");
      out.write("           // data : \"name=\" + name, \"email=\" + email, \"mobile=\" + mobile, \"username=\" + username, \"password=\" + password  \n");
